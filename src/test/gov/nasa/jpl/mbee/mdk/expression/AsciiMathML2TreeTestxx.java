	...
	*/
    ...
    <mrow>
      ...
      <mrow> ------------------ <mtable>
        ...
        //no mrow for [a,f] because DocProcess removed it?
        <mo>[</mo> ---------------<mtr><mtd>
        <mi>a</mi>
        <mo>,</mo> --------------</mtd><mtd>
        <mi>f</mi>
	   ...
	   */
	  //Even with DocPreprocess, the asciimath parser does not indluce the <mtable>   <mtr>   <mtd> like matrix without "f"
	  @org.junit.Test
	  public void test_matrix_2x3_problem_with_f() { testRoutine("[[a,f],[c,d],[e,h]]");}
...
<math>
    <mrow>
	   ...
	   */
	  //Even with DocPreprocess, the asciimath parser does not indluce the <mtable>   <mtr>   <mtd> like matrix without "g"
	  @org.junit.Test
	  public void test_matrix_2x3_problem_with_g() { testRoutine("[[a,b],[c,d],[e,g]]");}
...
*/
  ...
  <math>
	 ...
	 */
	@org.junit.Test
	public void test_ddx_0() { testRoutine("d/dxx^2");}
	/*
	 <math>
	    <mfrac>
	      <mi>d</mi>
	...
	*/
	@org.junit.Test
	public void test_ddx_1() { testRoutine("d/dxg(x)");}
/*
	  <math>
	    <mfrac>
	      <mrow>
...
*/
	@org.junit.Test
	public void test_dydx() { testRoutine("dy/dx");}
...
<math>
	 ...
	 */
	@org.junit.Test
	public void test_ddxy() { testRoutine("d/dxy");}
	...
	*/
	@org.junit.Test
	public void test_dfxdy() { testRoutine("d(f(x))/dy");}
	/*
	  <math>
	    <mi>f</mi>
	    <mrow>
	...
	@org.junit.Test
	public void test_dfxfxyz() { testRoutine("f(x) + f(x,y,z)");}
...
<math>
	...
	@org.junit.Test
	public void test_DIVIDES() {	testRoutine("f(a)+sum_(k=1)^n1/(k!)d^k/dt^k\u2223_(t=0) +f(u(t))+ int_0^1(1-t)^n/(n!)d^(n-1)/dt^(n-1)f(u(t))dt");}
	/*
	   <math>
    <mrow>
      <mo>(</mo>
	 ...
	 */ //from https://en.wikipedia.org/wiki/Chain_rule
	@org.junit.Test
	public void test_circ_cdot() {	testRoutine("(f @ g)^'(t) = f'(g(t))* g^'(t)");}
	/*
	  <math>
	    <mrow>
	      <mo>(</mo>
	...
	@org.junit.Test
	public void test_circ_cdot2() {	testRoutine("(f @ g)^'(t) = (-10.1325e^{-0.0001(4000 - 4.9t^2)})");}
